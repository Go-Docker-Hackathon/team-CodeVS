			...
			for (var i = 0, l = nodes.length; i < l; i++) {
				...
				if (openFlag) {
					...
					html.push("<button type='button' hidefocus='true' id='", node.tId, consts.id.ICON,
						"' title='' treeNode", consts.id.ICON," class='", view.makeNodeIcoClass(setting, node), "' style='", view.makeNodeIcoStyle(setting, node), "'></button><img src=\"img/", view.makeNodeIcoClass(setting, node), ".png\" style=\"margin-left:",node.level*25,"px;width:25px;height:12px;\"><span id='", node.tId, consts.id.SPAN,
						"'  style=\"  line-height:18px;margin-left:", node.level*10, "px\" margin-top:2px;>",name,"</span>");
